                    ...
                    <div class="ui fluid card">
                        ...
                        <div class="content body">
                            ...
                            <div class="step database" :class="{ active: stepIsActive(3) }">
                                ...
                                <div class="field">
                                    <button class="ui large blue big fluid button rounded mx-0" type="button"
                        ...
                        <div class="content footer ">
                            <button class="ui d-none  large previeus button ml-0 mr-auto" @click="navigateSteps(-1)"
                                type="button" v-if="step >= 2" :class="{ disabled: stepIsActive(1) }">{{ __('Previous') }}</button>
                            <button class="ui large green next button ml-auto mr-0" @click="navigateSteps(1)"
                                type="button" v-if="step <= 2">{{ __('Next') }}</button>
                            <button class="ui large green button ml-auto mr-0" type="button" @click="submitForm"
