                            ...
                            <div class="card-body">
                                ...
                                <div class="imageee text-center">
                                    @if (Auth::user()->is_expired_subscription)
                                        {{-- text --}}
                                        <img src="{{ asset('assets/images/expired.png') }}" height="300px"
                                            alt="">
                                    @else
                        ...
                        <div class="widget-stats-large-info-container">
                            ...
                            <div class="card-body account">
                                ...
                                <ul class="list-group account list-group-flush">
                                    ...
                                    <li class="list-group-item number">User ID : </li>
                                    <li class="list-group-item device">Number : </li>
    ...
    if (!is_expired_subscription) {
        ...
        socket.on('connection-open', ({
            ...
            if (token == device) {
                ...
                $('.number').html(`User ID : ${user.id}`)
                $('.device').html(`Number : ${token}`)
                $('.imageee').html(` <img src="{{ asset('assets/images/logo-icon.png') }}" height="300px" alt="">`)
